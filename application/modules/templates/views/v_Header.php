...
<html lang="en">
    ...
    <link rel="apple-touch-icon" href="<?= base_url('frontend');?>/assets/images/template/apple-touch-icon.png">
    ...
    <script src="<?= base_url('frontend');?>/assets/js/modernizer.js"></script>
